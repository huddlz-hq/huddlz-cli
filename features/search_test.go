...
func TestFeatures(t *testing.T) {
	...
	suite := godog.TestSuite{
		Name:    "huddlz",
		Options: &godog.Options{Format: "pretty", Paths: []string{"search.feature", "pagination.feature", "location.feature", "details.feature", "json.feature", "auth.feature"}, TestingT: t, Strict: true},
