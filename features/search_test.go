...
func TestFeatures(t *testing.T) {
	...
	suite := godog.TestSuite{
		Name:    "huddlz",
		Options: &godog.Options{Format: "pretty", Paths: []string{"search.feature", "pagination.feature", "location.feature", "details.feature", "json.feature", "auth.feature", "rsvp.feature", "rsvp_list.feature", "rsvp_cancel.feature", "profile.feature"}, TestingT: t, Strict: true},
